...
import com.iiita.models.Attribute;
...
//        JessApi jessApi = JessApi.getInstance();

        QuestionEngine questionEngine = new QuestionEngine();
        QuestionItem questionItem;
        while((questionItem = questionEngine.getNextQuestion()) != null)
        {
            System.out.println(questionItem.toString());
            questionEngine.pushAnswer(scan.nextBoolean());
        }
        System.out.println(questionEngine.getAnswer());
//        LinkedList<HarryPotterCharacter> suggestions = jessApi.getPrediction(query);
...
//    }
//
//    private static QuestionItem generateTables (LinkedList<HarryPotterCharacter> characters) {
